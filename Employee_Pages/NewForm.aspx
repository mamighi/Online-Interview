<%@ Page Title="" Language="C#" MasterPageFile="~/Employee_Pages/Employee_MasterPage.master" AutoEventWireup="true" CodeFile="NewForm.aspx.cs" Inherits="Employee_Pages_NewForm" %>
                    ...
                    <div class="zerogrid" style="height:488px; top: 0px; left: 0px;">
                        <div class="wrapper" style="height:100%">
                            <article class="col-1-3" style="width:25%">
                                    ...
                                    <strong><a href="Home.aspx"><span class="auto-style7">Home</span></a></strong></span><strong>
                                </strong>
                                </div>
					...
					<li><a href="CheckForm.aspx">Check Forms</a></li>
                            ...
                            <article class="col-2-3" style="height:100%">
                               ...
                               <div id="head" style="height:45px; line-height:3em; background:url(../images/center-shadow.png) center top no-repeat;" class="aligncenter">
                                   <span class="auto-style4">ADD NEW FORM</span>
                               </div>
                                <div style="width:100%;">
                                    <div style="width:100%;height:114px">
                                        <div style="float:left; color:blue;  line-height:40px; font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; width:111px; height:100%; line-height:40px; ">
                                            ...
                                            <br />
                                            <asp:ImageButton ID="ImageButton1" runat="server" CssClass="auto-style6" Height="24px" ImageUrl="~/images/submit_btn.png" OnClick="ImageButton1_Click" Width="63px" />
                                        ...
                                        <div style=" float:left; margin:0px; width:224px; line-height:40px; height: 100%;">
                                          ...
                                          <div style="width:100%; overflow-y: scroll; height: 325px;">
                                            <asp:Panel ID="Panel1" runat="server" Visible="False">
                                                ...
                                                &nbsp;<asp:ImageButton ID="ImageButton3" runat="server" ImageUrl="~/images/clear_btn.png" OnClick="ImageButton3_Click" />


                                                <asp:Label ID="Label5" runat="server" ForeColor="Red" Text="Please fill all questions" Visible="False"></asp:Label>
